...
class Admin_CellphoneController extends HandsOn_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->config = $this->view->gridConfig(
                $columns, $searchItems, $buttons, 'cellphone/list');
    ...
    public function listAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $cellPhoneList = $cellphone->getCellPhones(array(
                    'id', 'manufacturer', 'model'), $values);
            ...
            $this->view->total = $cellphone->count(
    ...
    public function addAction() {
        ...
        $form->setAction($this->view->baseUrl() . '/admin/cellphone/add');
    ...
    public function editAction() {
        ...
        $form = new CellPhoneForm();
        $form->setAction($this->view->baseUrl() . '/admin/cellphone/edit/id/'.$id);
    ...
    public function modifyAction() {
        if ($this->getRequest()->isPost()) {
            $cellId = (int)$this->getRequest()->getPost('id');
            $cellphone = new Cellphone(array('id' => $cellId));
