 ...
 * @license    http://framework.zend.com/license/new-bsd  New BSD License
 */
class Lembrefacil_Controller_Action_Helper_Acl extends Zend_Controller_Action_Helper_Abstract
{
    /**
    ...
    public function preDispatch()
    {
        ...
        if ($this->_auth->hasIdentity()) {
            ...
            if(is_object($user)) {
                $id_profile = $this->_auth->getIdentity()->id_profile;

                $userData = new User();
                $role = $userData->getRoleName($id_profile);
            }
        }
