...
class Numera_Mime
{
    ...
    public static function getMimeType($filename, $debug = false)
    {
        if (function_exists('finfo_open') && function_exists('finfo_file') && function_exists('finfo_close')) {
            ...
            if (!empty($mimeType)) {
                if (true === $debug) {
                    return array('mime_type' => $mimeType, 'method' => 'fileinfo');
                }
                return $mimeType;
            }
        }
        if (function_exists('mime_content_type')) {
            ...
            if (!empty($mimeType)) {
                if (true === $debug) {
                    return array('mime_type' => $mimeType, 'method' => 'mime_content_type');
                }
                return $mimeType;
            }
        }
        ...
        if (!empty(self::$_mimeTypes[$ext])) {
            if (true === $debug) {
                return array('mime_type' => self::$_mimeTypes[$ext], 'method' => 'from_array');
            }
